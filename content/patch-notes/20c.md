...
The exciting new thing for this update is **flavor text** for all the units! Huge thanks to `Ian "Marzeltine" Black` for writing it. You can view it in the **Fighter Almanac**:
...
- When you make an online game with "Random Map" selected, it should choose from player-created maps too, not just 
    - This will probably be limited to maps that have a certain threshold of upvotes -- maybe
...
- More gradual map editor improvements (some of these are mentioned above)
